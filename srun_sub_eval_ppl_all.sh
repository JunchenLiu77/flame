...
NUM_GPUS=8
COMMON_ARGS="--num_gpus $NUM_GPUS --batch_size 4"
...
EXP_NAMES=(
    ...
    # "lact_baseline_bs32_20k_only_w1_no_wn"
    "lact_baseline_bs32_20k_only_w1_no_wn_parallel"
    # "lact_baseline_bs32_20k_only_w1_no_wn_speedy"
    # "lact_baseline_bs32_20k_only_w1_speedy"
    # "lact_baseline_bs32_20k_only_w1_straight_qk_no_wn"
    # "lact_baseline_bs32_20k_only_w1_straight_qk_no_lr1_no_wn_momen"
)
