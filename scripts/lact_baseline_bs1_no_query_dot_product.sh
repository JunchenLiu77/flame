#!/bin/bash
#SBATCH --job-name=lact_baseline_bs1_no_query_dot_product
#SBATCH --output=exp/lact_baseline_bs1_no_query_dot_product/%x_%j.out
#SBATCH --error=exp/lact_baseline_bs1_no_query_dot_product/%x_%j.err
...
export WANDB_NAME="lact_baseline_bs1_no_query_dot_product"
