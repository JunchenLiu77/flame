#!/bin/bash
#SBATCH --job-name=lact_baseline_bs1
#SBATCH --output=exp/lact_baseline_bs1/%x_%j.out
#SBATCH --error=exp/lact_baseline_bs1/%x_%j.err
...
export WANDB_NAME="lact_baseline_bs1"
