#!/bin/bash
#SBATCH --job-name=lact_baseline_bs32_20k_only_w1
#SBATCH --output=exp/lact_baseline_bs32_20k_only_w1/%x_%j.out
#SBATCH --error=exp/lact_baseline_bs32_20k_only_w1/%x_%j.err
...
export WANDB_NAME="lact_baseline_bs32_20k_only_w1"

srun bash train.sh \
  --job.config_file flame/models/fla.toml \
  --job.dump_folder exp/$WANDB_NAME \
  --model.config configs/760M_lact_swiglu_nh4_fwlow_rank_momentum_muon_only_w1.json \
