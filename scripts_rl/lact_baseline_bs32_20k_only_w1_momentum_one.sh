...
export WANDB_NAME="lact_baseline_bs32_20k_only_w1_momentum_one"
...
bash train.sh \
  ...
  --model.config configs/760M_lact_swiglu_nh4_fwlow_rank_momentum_muon_only_w1_momentum_one.json \
