...
export WANDB_NAME="lact_baseline_bs32_20k_only_w1_straight_qk"
...
bash train.sh \
  ...
  --model.config configs/760M_lact_swiglu_nh4_fwlow_rank_momentum_muon_only_w1_straight_qk.json \
